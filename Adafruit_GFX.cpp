...
02/18/2013 	Charles-Henri Hallard (http://hallard.me)
                                                Modified for compiling and use
on Raspberry ArduiPi Board LCD size and connection are now passed as arguments
on the command line (no more #define on compilation needed) ArduiPi project
documentation http://hallard.me/arduipi 07/01/2013 	Charles-Henri Hallard
(http://hallard.me) Created Draw Bargraph feature Added printf feature
...
void Adafruit_GFX::drawVerticalBargraph(int16_t x, int16_t y, int16_t w,
...
void Adafruit_GFX::drawHorizontalBargraph(int16_t x, int16_t y, int16_t w,
                                          int16_t h, uint16_t color,
                                          uint16_t percent) {
  uint16_t hsize;
